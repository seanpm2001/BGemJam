...
![BGemJamGameIcon_LowQuality.png failed to load. The image may have been moved, the URL may be incorrect (check capitalization) the file may be corrupt, or your web browser implementation doesn't support the image linking method used.](/BGemJamGameIcon_LowQuality.png)

## By

[Seanpm2001](https://github.com/seanpm2001), Et; Al.

<!-- Add a special thanks message/set of messages here !-->
...
# BGemJam
BGemJam is a modern matching game similar to the Bejeweled series (since the Bejeweled games are getting very old, and losing support) I also feel like there should be an open source gem matching game. Candy crush is definitely **NOT** a viable replacement, and never will be.

***

## About

See above. This was the original old description for this project, but it still applies. Candy crush may be a viable replacement for some, but it isn't a viable replacement for the majority of Bejeweled/other gem matching game fans.
...
The website currently uses the Cayman theme, as it was the closest I could find to colorful gems on a default GitHub Pages Jekyll template.

***

## Wiki

[Click/tap here to view this projects Wiki](https://github.com/seanpm2001/BGemJam/wiki)
...
[Join the discussion on GitHub](https://github.com/seanpm2001/BGemJam/discussions)
...
This project was started as an original project during my early years of GitHub. It has expanded its purpose past games like bejeweled, to include various jewel matching games, the latest is Jewels by MHGames.

It is still a work in progress, and is not functional yet.
...
> * 1. [seanpm2001](https://github.com/seanpm2001/) - 47 commits (As of Monday, June 28th 2021 at 9:19 pm)
...
File version: `1 (Monday, June 28th 2021 at 9:19 pm)`
...
Version 1 (Monday, June 28th 2020 at 9:19 pm)
